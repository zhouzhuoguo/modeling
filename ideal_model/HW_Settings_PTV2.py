...
TECH        = 28 # 28 nm
SYA_AREA    = 1 # synthesis area, 1024 IN8 (mixed precision)
...
# PRE-START
FRE_RATIO   = 1/2 * BITWIDTH_RATE # OFF-CHIP / ON-CHIP: 1: 32B=256b
...
# STAT
# #############################################################
NUMCLK      = 93290000 if not ENA_ABS else 93290000
